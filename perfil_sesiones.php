...
<div class="app-panel-header">
  <div class="app-panel-header-inner">
    <h3 class="app-section-title m-0"><i class="fas fa-history me-2"></i> Sesiones Activas</h3>
    <p class="app-panel-subtitle">Monitorea accesos recientes y revoca sesiones activas con una tabla responsiva.</p>
  </div>
      ...
      <table class="table table-striped align-middle">
        ...
        <tbody>
          <?php while ($row = $result->fetch_assoc()): ?>
            <tr>
              <td><code class="app-code"><?= htmlspecialchars($row['ip_address']) ?></code></td>
